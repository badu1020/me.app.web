...
const features = [
  {
    name: 'ЗЭЭЛ АВАХ ХЯЛБАР АРГА',
    description:
      'Хүссэн байгууллагаас хялбар аргаар санхүүгийн үйлчилгээ авах боломжтой. Тухайн санхүүгийн байгууллагын дотоод бүртгэл тооцооны үйл ажиллагааг автоматаар гүйцэтгэх тул цаг хугацаа зардлыг бууруулна.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'ҮРГЭЛЖ НЭЭЛТТЭЙ',
    description:
      '24/7 цагийн турш дэлхийн хаанаас ч, хэзээ ч аппликеишнээ ашиглан зээл авах болон бусад үйлчилгээг авах боломжтой',
    icon: DeviceNotificationIcon,
    screen: StocksScreen,
  },
  {
    name: 'БҮХ ДАНСАА НЭГ ДОРООС',
    description:
      'Таны харилцдаг бүх санхүүгийн байгууллагад бүртгэлтэй данснуудаа нэг дороос удирдах боломж. Хугацаатай болон хугацаагүй хадгаламжаас сонгон өөрт тохирох дансаа үүсгэж хуримтлал үүсгэх',
        ...
        <FadeIn>
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
            ...
            <p className="mt-2 text-lg text-white font-medium">
              ББСБ, ХЗХ-ны харилцагч, гишүүд санхүүгийн яаралтай хэрэгцээ гарсан үед цаг хугацаа, орон зайнаас үл хамаарч үйлчилгээ авах хүсэлтэй байна.
            </p>
          </div>
        </FadeIn>
      </Container>
